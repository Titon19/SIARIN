        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr width="1" align="center">
                    ...
                    <td width="1">
                        <a href="absensi_ubah.php?id_absensi=<?php echo $data['id_absensi']; ?>" class="btn btn-info"><img src="../gambar/edit.png" alt="edit"></a><br>
                        <a href="absensi_hapus.php?id_absensi=<?php echo $data['id_absensi']; ?>" class="btn btn-danger" style="align-content: center;padding-left:8px;padding-right:8px;"><img src="../gambar/hapus.png" alt="hapus"></a><br>

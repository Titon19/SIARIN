        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                    ...
                    <td width="1">
                        <a href="agenda_ubah.php?id_rapat=<?php echo $data['id_rapat']; ?>" class="btn btn-info"><img src="../gambar/edit.png" alt="edit"> </a><br>
                        <a href="agenda_hapus.php?id_rapat=<?php echo $data['id_rapat']; ?>" class="btn btn-danger" style="align-content: center;padding-left:8px;padding-right:8px;"> <img src="../gambar/hapus.png" alt="hapus"> </a><br>

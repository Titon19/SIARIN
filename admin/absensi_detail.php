...
<body style="margin: 0px 50px 0px 50px;">
    <table align="center" class="table">
        ...
        $detail = mysqli_query($koneksi, "SELECT absensi.id_absensi, agenda_rapat.id_rapat, absensi.pimpinan_rapat, absensi.peserta, absensi.waktu FROM absensi INNER JOIN agenda_rapat ON absensi.id_rapat=agenda_rapat.id_rapat WHERE id_absensi='$_GET[id_absensi]'");

    ...
    <div class="table-responsive px-4">
        ...
        <table class="table table-bordered">
            <tr class="table-light" style="text-align:center;">
                <th width="1">No</th>
                <th width="1">Nama Ruangan</th>
                <th>Tempat</th>
                <th width="1">Kapasitas</th>
                <th>Aksi</th>
            </tr>
            <?php
            include('../koneksi.php');
            ...
            ?>
                <tr>
                    ...
                    <td width="1">
                        <a href="ruangan_ubah.php?no=<?php echo $data['no']; ?>" class="btn btn-info" style="width: max-content;"> <img src="../gambar/edit.png" alt="edit"> </a><br>
                        <a href="ruangan_hapus.php?no=<?php echo $data['no']; ?>" class="btn btn-danger" style="align-content: center;padding-left:8px;padding-right:8px;"> <img src="../gambar/hapus.png" alt="hapus"> </a><br>
                        <a href="ruangan_detail.php?no=<?php echo $data['no']; ?>" class="btn btn-warning" style="align-content: center;padding-left:8px;padding-right:8px;"> <img src="../gambar/detail.png" alt="detail"> </a><br>
                    </td>
                </tr>
            <?php } ?>
        </table>

...
<body style="margin: 0px 50px 0px 50px;">
    <div class="container">
        <table align="center" class="table">
            ...
            $detail = mysqli_query($koneksi, "SELECT notulen.id_notulen, notulen.id_rapat, absensi.id_absensi, absensi.pimpinan_rapat, absensi.peserta, notulen.notulen FROM notulen INNER JOIN agenda_rapat INNER JOIN ruangan INNER JOIN absensi ON notulen.id_rapat=agenda_rapat.id_rapat AND notulen.id_absensi=absensi.id_absensi WHERE id_notulen='$_GET[id_notulen]'");
            ...
            <tr>
                <td colspan="3" align="center"><a href="notulen.php" class="btn btn-success">Kembali</a></td>
            </tr>
